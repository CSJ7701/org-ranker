...
* Roadmap
** TODO Update regex for ranker rule to allow for custom scoring functions
** TODO Make 'CSV.el' dependency optional
** TODO org-ranker-list-properties should work with universal argument
** TODO Make Org-Ranker work on top level headings, and subheadings
